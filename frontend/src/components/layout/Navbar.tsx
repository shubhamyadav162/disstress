...
import { Home, Menu, X, Building2, Building, LandPlot, Users, User, LogOut, ChevronDown, Gavel, Crown } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { cn } from '@/lib/utils';
import { useAuth } from '@/contexts/AuthContext';

const navLinks = [
  { name: 'Distress Listings', href: '/listings?listingType=SELL', icon: Building2 },
  { name: 'Bank Auction', href: '/listings?type=AUCTION', icon: Gavel },
  { name: 'Commercial', href: '/listings?type=OFFICE', icon: LandPlot },
  { name: 'Luxury Flats', href: '/listings?type=LUXURY', icon: Crown },
];
          ...
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2 group">
              ...
              <div className="flex flex-col">
                <span className="font-heading font-bold text-base md:text-lg text-primary leading-tight">
                  Prime Distress
                </span>
                <span className="text-[10px] md:text-xs font-medium text-muted-foreground uppercase tracking-[0.2em] leading-tight">
                  Properties
                </span>
              </div>
            </Link>
              ...
              {!isLoading && (
                <>
                  {isAuthenticated && user ? (
                    ...
                    <Link to="/login">
                      <Button variant="outline" className="rounded-full hidden sm:flex border-primary text-primary hover:bg-primary hover:text-primary-foreground">
                        Login / Sign Up
                      </Button>
                    </Link>
                  )}
