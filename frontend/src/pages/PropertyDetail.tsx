...
import {
    ...
    Building2, Sofa, Clock, IndianRupee, Shield,
    ArrowLeft, Loader2, X, CheckCircle2, TrendingDown, Car, FileText, AlertTriangle
} from 'lucide-react';
            ...
            <div className="min-h-screen bg-background">
                ...
                <main className="pt-24 pb-16">
                    <div className="container mx-auto px-4 text-center py-20">
                        ...
                        <Button onClick={() => navigate('/listings')}>Browse Distress Listings</Button>
                    </div>
                </main>
                <Footer />
            </div>
                        ...
                        <div className="lg:col-span-8 relative aspect-[4/3] md:aspect-[16/9] rounded-2xl overflow-hidden shadow-elevated bg-muted">
                            ...
                            <div className="absolute top-4 left-4 flex flex-wrap gap-2 pointer-events-none">
                                {property.owner.isVerified && (
                                    <Badge className="bg-emerald-500/90 backdrop-blur-md shadow-lg border-none">
                                ...
                                <Badge className="bg-red-500/90 backdrop-blur-md shadow-lg border-none">
                                    {property.type}
                                </Badge>
                            </div>
                            ...
                            {property.images.length > 1 && (
                                <>
                                    <button
                                        ...
                                        className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/20 backdrop-blur-md border border-white/30 text-white flex items-center justify-center hover:bg-white/40 transition-all"
                                    >
                                        <ChevronLeft className="w-6 h-6" />
                                    </button>
                                    <button
                                        onClick={() => setCurrentImage(prev => (prev + 1) % property.images.length)}
                                        className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/20 backdrop-blur-md border border-white/30 text-white flex items-center justify-center hover:bg-white/40 transition-all"
                                    >
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-card rounded-xl p-6 border border-border">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-muted-foreground line-through">₹{(property.price * 1.35 / 10000000).toFixed(2)} Cr</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-foreground font-semibold">Distress Sale Price</span>
                                        <span className="text-primary font-bold text-xl">{formatPrice(property.price, property.listingType)}</span>
                                    </div>
                                    <div className="h-px bg-border" />
                                    <div className="flex justify-between items-center">
                                        <span className="text-emerald-400 font-medium">Estimated Savings</span>
                                        <span className="savings-badge">~35% Below Market</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div className="bg-card rounded-xl p-4 text-center border border-border">
                                    ...
                                    <p className="text-xs text-muted-foreground">Sq. Ft. Built-up</p>
                                </div>
                                <div className="bg-card rounded-xl p-4 text-center border border-border">
                                ...
                                <div className="bg-card rounded-xl p-4 text-center border border-border">
                                    ...
                                    <p className="font-semibold text-sm">Semi Furnished</p>
                            ...
                            <div className="bg-card rounded-xl p-6 border border-border">
                                ...
                                <ul className="space-y-2">
                                    <li className="flex items-center gap-2 text-sm text-muted-foreground">
                                        ...
                                        Below market price - significant savings opportunity
                                    </li>
                                    <li className="flex items-center gap-2 text-sm text-muted-foreground">
                                        <CheckCircle2 className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                                        Verified listing with document support available
                                    </li>
                                    <li className="flex items-center gap-2 text-sm text-muted-foreground">
                                        <CheckCircle2 className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                                        Prime location in high-demand business district
                                    </li>
                                    <li className="flex items-center gap-2 text-sm text-muted-foreground">
                                        <CheckCircle2 className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                                        Available for immediate closure
                                    </li>
                                </ul>
                            </div>

                            <div className="bg-card rounded-xl p-6 border border-border">
                                <h2 className="font-heading text-lg font-semibold mb-4">Commission Terms</h2>
                                <p className="text-muted-foreground">
                                    Commission details are disclosed upfront for every listing. Contact the advisor for complete breakdown of pricing and commission structure.
                                </p>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                <div className="flex items-center gap-3 mb-4 pb-4 border-b border-border">
                                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center overflow-hidden">
                                        {property.owner.avatar ? (
                                            <img src={property.owner.avatar} alt={property.owner.name || 'Advisor'} className="w-full h-full object-cover" />
                                        ) : (
                                            <User className="w-6 h-6 text-primary" />
                                        )}
                                    </div>
                                    <div>
                                        <p className="font-semibold">{property.owner.name || 'Property Advisor'}</p>
                                        {property.owner.isVerified && (
                                ...
                                <div className="mt-4 flex items-center justify-center gap-2 text-sm text-muted-foreground">
                                    ...
                                    <span>Verified &bull; Commission Transparent</span>
                                </div>
                            </motion.div>
                    ...
                    >
                        ...
                        >
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="font-heading text-xl font-semibold">Contact Advisor</h3>
                                <button
                                    onClick={() => setShowContactModal(false)}
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-4 p-4 bg-muted rounded-xl">
                                    <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center overflow-hidden">
                                        {property.owner.avatar ? (
                                            <img src={property.owner.avatar} alt={contactInfo.ownerName} className="w-full h-full object-cover" />
                                        ) : (
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <a
                                        href={`https://wa.me/91${contactInfo.ownerPhone.replace(/\D/g, '')}?text=Hi, I am interested in the distress property: ${contactInfo.propertyTitle}`}
                                        target="_blank"
                                ...
                                <p className="text-center text-sm text-muted-foreground">
                                    Commission terms discussed directly with advisor
                                </p>
                            </div>
                        </motion.div>
                    </motion.div>
